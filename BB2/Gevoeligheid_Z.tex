...
en tevens is dan ook et potentiaalverval over R gelijk aan het potentiaalverval over $R_B$ zodat:
\\
...
Is het evenwicht van de brug gerealiseerd is, dan kan men de onbekende weerstand $R_X$ vinden met:
\\
...
Gezien de de grootheden geijkt zijn, is de fout hierop nul. Vereenvoudigd vinden we:
\\
...
Gezien de opstelling van de Brug van Wheatstone kan men de $I_x$ en $I_a$ bepalen aan de hand van de wet van Ohm.
...
Voor de formules van schakeling (b) te bepalen verwisselen we slechts de grootheden $R$ en $R_A$ 
...
\subsection{Theoretische waarden}
